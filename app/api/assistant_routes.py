...
PLATFORM_GUIDE = (
    ...
    "Aya · Assistant IA (cette page), Rapports, Veille Marché (prix réels + synthèse IA + un flux UNIQUE d'actualités filière — marché & réglementaire/EUDR mêlés — filtrable par catégorie et par âge de l'info).\n"
    ...
    "• VEILLE MARCHÉ : prix réels (cours mondial ICE New York + prix bord-champ officiel CCC), synthèse IA "
    "stratégique (en cache, régénérée au « Actualiser » — admin/agronome), et un FLUX UNIQUE d'actualités de la "
    "filière regroupant marché ET réglementaire/EUDR/durabilité — filtrable par catégorie (chips) et par "
    "« Âge de l'info » (fenêtres de 3 à 24 mois). Un admin peut « Rafraîchir les sources » (moteur de veille "
    "open-source RSS). Plus de doublon : une seule liste, une seule synthèse.\n"

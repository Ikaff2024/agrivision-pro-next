...
def evaluate_shade_balance(inp: CacaoInputs) -> ModuleResult:
    """Évalue la densité d'ombrage autour des cacaoyers."""
    if inp.shade_tree_density_pct is None:
        score, reason = 40.0, "Densité d'ombrage inconnue : pénalité appliquée."
        ...
        score, reason = 70.0, "Ombrage élevé : peut limiter la photosynthèse."
    else:
        score, reason = 40.0, "Ombrage excessif : humidité stagnante et risque de maladies."
